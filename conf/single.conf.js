exports.config = {
  ...
  server: process.env.LT_GRID_URL ||'https://faisalr:34ixUwLwZu53NVzs8V95u573CiZIJ7KBMvTyT3BSxC0RCE3TM0@hub.lambdatest.com/wd/hub',
  capabilities: [{
    browserName: process.env.LT_BROWSER_NAME || 'chrome',
    name: process.env.LT_BUILD_NUMBER || "local_test",
