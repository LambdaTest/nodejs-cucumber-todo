# Run Node.js Cucumber Tests on TestMu AI (Formerly LambdaTest)
...
```bash
git clone https://github.com/LambdaTest/nodejs-cucumber-todo && cd nodejs-cucumber-todo
npm install
```
...
For a single environment test run:
